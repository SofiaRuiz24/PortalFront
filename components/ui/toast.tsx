...
const toastVariants = cva(
  ...
  "overflow-hidden rounded-md border-2 p-4 pr-6 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 "+
  ...
  "data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        default: " border-foreground bg-chart-3/90 text-foreground text-white ",
        destructive:
          "destructive group border-foreground bg-destructive/90 text-destructive-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
